  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    	...
    	<div class="container-fluid px-0">
    		<div class="row d-md-flex text-wrapper">
              ...
              <ul class="my-4">
              	...
              	<li><span class="ion-ios-checkmark-circle mr-2"></span> To promote spiritual growth, both personal and cooperate.</li>
              	<li><span class="ion-ios-checkmark-circle mr-2"></span> To encourage members in personal service and evangelistic outreach for others.</li>
    ...
    <section class="ftco-counter" id="section-counter">
          ...
          <div class="col-md-3 justify-content-center counter-wrap ftco-animate">
            <div class="block-18 text-center py-5">
              <div class="text">
                ...
                <strong class="number" data-number="1206">0</strong>
                <span>Zunde Baptisms</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block">
              <div class="icon"><img src="images/asa.png" alt="" style="max-height: 5rem;"></div>
              <div class="media-body">
		...
		<section class="ftco-section bg-light" id="sermons-section">
        	...
        	<div class="col-md-4">
        		<div class="sermon-wrap ftco-animate">
    					<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/0.jpeg);">
    						<div class="text-content p-4 text-center">
    							<span>by Elder:</span>
    							<h3>Harrison Ziyambi</h3>
    							<p class="">
										<a href="#" class="btn-custom mb-2 p-2 text-center popup-vimeo"><span class="icon-play"></span> Watch</a>
        	...
        	<div class="col-md-4">
        		<div class="sermon-wrap ftco-animate">
    					<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/kunze.jpg);">
    						<div class="text-content p-4 text-center">
    							<span>by elder:</span>
    							<h3>Tatenda Kunze</h3>
    							<p class="">
    					...
    					<div class="text pt-3 text-center">
    						<h2 class="mb-0"><a href="#">Developing Spiritual Mentality</a></h2>
    						<div class="meta">
		  						<p class="mb-0">
			  						<span>July 01, 2019</span>
		  						</p>
        	...
        	<div class="col-md-4">
        		<div class="sermon-wrap ftco-animate">
    					<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/20191130_114640.jpg);">
    						<div class="text-content p-4 text-center">
    							<span>by elder:</span>
    							<h3>Advocate Thabani Mpofu</h3>
    							<p class="">
										<a href="#" class="btn-custom mb-2 p-2 text-center popup-vimeo"><span class="icon-play"></span> Watch</a>
										<a href="#" class="btn-custom p-2 text-center"><span class="icon-download"></span> Download</a>
									</p>
    					...
    					<div class="text pt-3 text-center">
    						<h2 class="mb-0"><a href="#">Doing the work of an Advocate</a></h2>
    						<div class="meta">
		  						<p class="mb-0">
        	...
        	<div class="col-md-4">
        		<div class="sermon-wrap ftco-animate">
    					<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/event.jpg);">
    						<div class="text-content p-4 text-center">
    							<span>from CUTASA:</span>
    							<h3>Chosen Zunde Choir</h3>
    							<p class="">
										<a href="https://www.youtube.com/watch?v=XZtXgyyuzPE" class="btn-custom mb-2 p-2 text-center popup-vimeo"><span class="icon-play"></span> Watch</a>
										<a href="#" class="btn-custom p-2 text-center"><span class="icon-download"></span> Download</a>
									</p>
    						</div>
    					</div>
    					<div class="text pt-3 text-center">
    						<h2 class="mb-0"><a href="sermon.html">Singing through Verses</a></h2>
    						<div class="meta">
		  						<p class="mb-0">
        	...
        	<div class="col-md-4">
        		<div class="sermon-wrap ftco-animate">
    					<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/20191130_103822.jpg);">
    						<div class="text-content p-4 text-center">
    							<span>from PCM:</span>
    							<h3>Homeland Glory</h3>
    							<p class="">
										<a href="https://www.youtube.com/watch?v=6f72o3LNRGs&t=33s" class="btn-custom mb-2 p-2 text-center popup-vimeo"><span class="icon-play"></span> Watch</a>
										<a href="#" class="btn-custom p-2 text-center"><span class="icon-download"></span> Download</a>
									</p>
    						</div>
    					</div>
    					<div class="text pt-3 text-center">
    						<h2 class="mb-0"><a href="#">Somebody Loves Me</a></h2>
    						<div class="meta">
		  						<p class="mb-0">
        	...
        	<div class="col-md-4">
        		<div class="sermon-wrap ftco-animate">
    					<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/global.jpg);">
    						<div class="text-content p-4 text-center">
    							<h3>Vana Baba</h3>
    							<p class="">
										<a href="https://www.youtube.com/watch?v=q9E2zFtaeLk" class="btn-custom mb-2 p-2 text-center popup-vimeo"><span class="icon-play"></span> Watch</a>
										<a href="#" class="btn-custom p-2 text-center"><span class="icon-download"></span> Download</a>
									</p>
    						</div>
    					</div>
    					<div class="text pt-3 text-center">
    						<h2 class="mb-0"><a href="#">Pasi Rizere Matambudzo</a></h2>
    						<div class="meta">
		  						<p class="mb-0">
			  						<span>July 01, 2019</span>
		  						</p>
		...
		<section class="ftco-section bg-light ftco-event" id="events-section">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
				...
				<div class="row">
					<div class="col-md-12 col-lg-6 col-xl-4">
						<div class="event-wrap d-flex ftco-animate">
							<div class="img" style="background-image: url(images/wedding.jpeg);"></div>
							<div class="text p-4 d-flex align-items-center">
								<div>
									<span class="time">01<small>st</small> August 2020</span>
									<h3><a href="#">Rutendo &amp; Tinotenda Wedding</a></h3>
									<div class="meta">
										<p><span class="icon-star mr-1"></span> <a href="#">CUT ASA wedding</a></p>
										<p><span class="icon-location"></span>
											Wedding between an ASA member Rutendo and UZ Alumni Tinotenda.
											</p>
        	...
        	<div class="col-md-12 col-lg-6 col-xl-4">
        		<div class="event-wrap d-flex ftco-animate">
        			<div class="img" style="background-image: url(images/20191130_114640.jpg);"></div>
        			<div class="text p-4 d-flex align-items-center">
        				<div>
	        				<span class="time">30<small>th</small> November 2019</span>
	        				<h3><a href="#">Public Campus Ministries</a></h3>
	        				<div class="meta">
		        				<p><span class="icon-user mr-1"></span> by elder: <a href="#">Thabani Mpofu</a></p>
		        				<p><span class="icon-location"></span> Doing the work of an Advocate. Jesus Christ being the Advocate</p>
		        				<p class="mb-0"><a href="#" class="btn btn-primary">Join Us</a></p>
	        				</div>
	        			</div>
        			</div>
        	...
        	<div class="col-md-12 col-lg-6 col-xl-4">
        		<div class="event-wrap d-flex ftco-animate">
        			<div class="img" style="background-image: url(images/carlson.jpeg);"></div>
        			<div class="text p-4 d-flex align-items-center">
        				<div>
	        				<span class="time">27<small>th</small> November 2019</span>
	        				<h3><a href="#">Carlson &amp; Mufaro </a></h3>
	        				<div class="meta">
		        				<p><span class="icon-star mr-1"></span><a href="#">Association Wedding</a></p>
		        				<p><span class="icon-location"></span>Wedding between a CUT ASA member Mufaro and CUTASA Alumni member Carlson</p>
		        				<p class="mb-0"><a href="#" class="btn btn-primary">Join Us</a></p>
	        				</div>
	        			</div>
        			</div>
        	...
        	<div class="col-md-12 col-lg-6 col-xl-4">
        		<div class="event-wrap d-flex ftco-animate">
        			<div class="img" style="background-image: url(images//camp.jpeg);"></div>
        			<div class="text p-4 d-flex align-items-center">
        				<div>
	        				<span class="time">18<small>th</small> May 2019</span>
	        				<h3><a href="#">Semester Camp Meeting</a></h3>
	        				<div class="meta">
		        				<p><span class="icon-play-circle-o mr-1"></span><a href="#"> hosted by Socie Department</a></p>
		        				<p><span class="icon-location"></span>Social Camp Meeting at Naishe Gardens, All are invited</p>
		        				<p class="mb-0"><a href="#" class="btn btn-primary">Join Us</a></p>
	        				</div>
	        			</div>
        			</div>
        	...
        	<div class="col-md-12 col-lg-6 col-xl-4">
        		<div class="event-wrap d-flex ftco-animate">
        			<div class="img" style="background-image: url(images/hand-shake2-1080x720.jpg);"></div>
        			<div class="text p-4 d-flex align-items-center">
        				<div>
        	...
        	<div class="col-md-12 col-lg-6 col-xl-4">
        		<div class="event-wrap d-flex ftco-animate">
        			...
        			<div class="text p-4 d-flex align-items-center">
        				<div>
	        				<span class="time">13th June 2018</span>
	        				<h3><a href="#">Little England Zunde</a></h3>
	        				<div class="meta">
		        				<p><span class="icon-user mr-1"></span> by elder: <a href="#">Obey Chimuka</a></p>
		        				<p><span class="icon-location"></span> A remote area, occupied by farm workers and villages</p>
		        				<p class="mb-0"><a href="#" class="btn btn-primary">Join Us</a></p>
	        				</div>
	        			</div>
        			</div>
		...
		<section class="ftco-section ftco-causes ftco-no-pb" id="causes-section">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-3">
						<div class="cause-entry ftco-animate">
							<a href="#" class="img" style="background-image: url(images/event.jpg);"></a>
							<div class="text p-3">
								<h3><a href="#">End of Semester Zunde</a></h3>
								<p class="text-justify">
									At the end of every semester students and Alumni host a zunde meeting where they spread the Gospel of Christ to any Chosen Location.
					...
					<div class="col-md-6 col-lg-3">
						<div class="cause-entry ftco-animate">
							<a href="#" class="img" style="background-image: url(images/camp.jpeg);"></a>
							<div class="text p-3">
				...
				<div class="row mt-4 justify-content-end" id="donate">
					<div class="col-lg-10">
		...
		<div class="container">
			...
			<div class="col-md-7 heading-section text-center ftco-animate">
				...
				<p>God`s claim is to take precedence of any other claim and must be discharged first. Then the poor
					and the needy are to be cared for. <span class="text-success"> The youth`s Instructor. August 26 1896.</span>
					{WM 277.3}
				</p>
			</div>
			</div>
			...
			<div class="container-fluid px-4">
			  ...
			  <div class="col-md-7 heading-section ftco-animate text-center">
				...
				<div class="row">
						...
						<div class="col-md-3 ftco-animate">
							<a href="images/global1.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/global1.jpg);">
								<div class="icon mb-4 d-flex align-items-center justify-content-center">
								<span class="icon-instagram"></span>
							</div>
							</a>
						...
						<div class="col-md-3 ftco-animate">
							<a href="images/camp.jpeg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/camp.jpeg);">
								<div class="icon mb-4 d-flex align-items-center justify-content-center">
								<span class="icon-instagram"></span>
							</div>
							</a>
						...
						<div class="col-md-3 ftco-animate">
							<a href="images/pcm.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/pcm.jpg);">
								<div class="icon mb-4 d-flex align-items-center justify-content-center">
								<span class="icon-instagram"></span>
							</div>
							</a>
						...
						<div class="col-md-3 ftco-animate">
							<a href="images/20191130_103822.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/20191130_103822.jpg);">
								<div class="icon mb-4 d-flex align-items-center justify-content-center">
								<span class="icon-instagram"></span>
							</div>
							</a>
						...
						<div class="col-md-3 ftco-animate">
							<a href="images/event.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/event.jpg);">
								<div class="icon mb-4 d-flex align-items-center justify-content-center">
								<span class="icon-instagram"></span>
							</div>
							</a>
						...
						<div class="col-md-3 ftco-animate">
							<a href="images/homeland1.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/homeland1.jpg);">
								<div class="icon mb-4 d-flex align-items-center justify-content-center">
								<span class="icon-instagram"></span>
							</div>
							</a>
		...
		<section class="ftco-section ftco-no-pb" id="subscribe">
			<div class="container">
				<div class="row justify-content-center pb-5">
			...
			<div class="row">
						...
						<div class="col-md-6 col-lg-3 ftco-animate">
							<div class="staff">
								<div class="img-wrap d-flex align-items-stretch">
									<div class="img align-self-stretch" style="background-image: url(images/kundai.jpg);"></div>
								</div>
								<div class="text d-flex align-items-center pt-3 text-center">
									<div>
						...
						<div class="col-md-6 col-lg-3 ftco-animate">
							<div class="staff">
								<div class="img-wrap d-flex align-items-stretch">
									<div class="img align-self-stretch" style="background-image: url(images/kunze.jpg);"></div>
								</div>
								<div class="text d-flex align-items-center pt-3 text-center">
									<div>
      ...
      <div class="container">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                <li><a href="pdfs/Constitution due for print with logo.pdf" download class="py-1 d-block"><span class="ion-ios-arrow-forward mr-3"></span>Our Constitution</a></li>
                <li><a href="pdfs/ADV-28Beliefs2020.pdf" download class="py-1 d-block"><span class="ion-ios-arrow-forward mr-3"></span>Beliefs</a></li>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
				Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Website made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://gmitech.site" target="_blank">Great Minds Investments</a>
			</p>
          </div>
        </div>
      </div>
